...
public class LendingTransactionController {
    ...
    @PutMapping("/{id}")
    public ResponseEntity<LendingTransactionDto> updateTransaction(@PathVariable Long id, @RequestBody LendingTransactionDto lendingTransactionDto) throws IOException {
        LendingTransactionDto updateLendingTransactionDto = lendingTransactionService.updateTransaction(id, lendingTransactionDto);
        return ResponseEntity.ok(updateLendingTransactionDto);
    }
}
